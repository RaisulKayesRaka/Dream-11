...
import bgCover from "/assets/bg-shadow.png";


export default function Banner({ handleClaimCredit }) {
  return (
    <div style={{ backgroundImage: `url(${bgCover})` }} className="mx-auto w-11/12 max-w-[1320px] bg-cover bg-center bg-no-repeat rounded-3xl bg-black text-white">
